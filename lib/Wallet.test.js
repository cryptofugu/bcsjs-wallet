...
describe("Wallet", () => {
    ...
    it("sends payment to a receiving address", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.assert.equal(senderOldInfo.coinBalance - senderNewInfo.coinBalance, Math.round(1.009 * 1e8), "sender");
            chai_1.assert.equal(receiverNewInfo.coinBalance - receiverOldInfo.coinBalance, 1e8, "receiver");
        });
    });
});
